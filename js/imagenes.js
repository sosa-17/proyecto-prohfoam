...
$(document).ready(function(){
  $.ajax({
    url:"ajax/gestion-producto.php?accion=CategoriaSala",
    data:" ",
    method:"POST",
    success:function(respuesta){
      //alert(respuesta);
      $("#div-categoriasala").html(respuesta);
    },
    error:function(e){
      //alert("Error "+e);
    }
...
$(document).ready(function(){
  $.ajax({
    url:"ajax/gestion-producto.php?accion=CategoriaDormitorio",
    data:" ",
    method:"POST",
    success:function(respuesta){
      //alert(respuesta);
      $("#div-categoriadormitorio").html(respuesta);
    },
    error:function(e){
      //alert("Error "+e);
    }
...
$(document).ready(function(){
  $.ajax({
    url:"ajax/gestion-producto.php?accion=CategoriaOficina",
    data:" ",
    method:"POST",
    success:function(respuesta){
      //alert(respuesta);
      $("#div-categoriaoficina").html(respuesta);
    },
    error:function(e){
      //alert("Error "+e);
    }
